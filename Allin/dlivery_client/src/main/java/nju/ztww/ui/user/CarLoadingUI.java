...
public class CarLoadingUI extends JPanel{
	...
	public CarLoadingUI(){
		...
		ImageIcon Money=new ImageIcon("photo/moneyLabel.gif");
		ImageIcon Jianzhuang=new ImageIcon("photo/jianzhuangLabel.gif");
		ImageIcon Yayun=new ImageIcon("photo/yayunLabel.gif");
...
//			                60));
			  ...
			  addButton.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
			            ...
			            dlg.add(sureButton);
			            sureButton.setBounds(200, 350, 60, 40);
