...
public interface FinanceDataService {
	//TODO
		 ...
		 */
			 ...
			 */
			public AccountPO checkAccount(String accountID);
			 ...
			 */
			public boolean checkList(OrderPO order);
			 ...
			 */
			public boolean add(String diagram);
			 ...
			 */
			public boolean delete(String diagram);
